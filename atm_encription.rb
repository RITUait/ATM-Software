...
#To take user input
def input(account_id, accounts,trans_array)
  require 'io/console'
  if accounts[account_id]
    ...
    details_store(name,pass_encripted, balance, accounts, account_id,trans_array)
